...
IUSE="cgi ipv6 milter rrdtool systemd"
# https://www.rhyolite.com/dcc/ says
# "You can redistribute unchanged copies of the DCC source, but you may not
# redistribute modified, "fixed," or "improved" versions of the source or
# binaries. You also can't call it your own or blame anyone for the results of
# using it."
RESTRICT="bindist"
...
src_install() {
	...
	use systemd && systemd_dounit "${FILESDIR}/dccifd.service"
}
