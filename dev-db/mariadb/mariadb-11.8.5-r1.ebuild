...
inherit cmake flag-o-matic java-pkg-opt-2 multiprocessing pam prefix systemd toolchain-funcs
...
src_configure() {
	...
	if use server ; then
		...
		mycmakeargs+=(
			...
			-DWITH_INNODB_BZIP2=$(usex innodb-bzip2 ON OFF)
			-DWITH_INNODB_LZ4=$(usex innodb-lz4 ON OFF)
			-DWITH_INNODB_LZMA=$(usex innodb-lzma ON OFF)
