...
IUSE="cma cuda fortran ipv6 openmpi_fabrics_knem openmpi_fabrics_ofed openmpi_rm_pbs openmpi_rm_slurm peruse romio valgrind"
...
src_configure() {
	...
	local myconf=(
		...
		#   has fallen into disrepair and is currently known to be
