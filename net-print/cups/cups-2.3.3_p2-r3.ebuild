...
inherit autotools flag-o-matic linux-info optfeature pam systemd toolchain-funcs xdg multilib-minimal
...
multilib_src_configure() {
	...
	local myeconfargs=(
		...
		--with-rundir="${EPREFIX}"/var/run/cups
		--with-cups-user=lp
		--with-cups-group=lp
...
multilib_src_install_all() {
	...
	echo "ServerName ${EPREFIX}/var/run/cups/cups.sock" >> "${ED}"/etc/cups/client.conf
