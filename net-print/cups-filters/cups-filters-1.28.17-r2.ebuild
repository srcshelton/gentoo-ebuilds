...
inherit flag-o-matic perl-module systemd
...
LICENSE="MIT GPL-2"
SLOT="0"
IUSE="dbus exif +foomatic jpeg ldap pclm pdf perl png +postscript systemd test tiff zeroconf"
...
src_configure() {
	...
	local myeconfargs=(
		...
		--with-cups-rundir="${EPREFIX}"/var/run/cups
