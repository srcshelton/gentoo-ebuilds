...
SRC_URI="
	https://github.com/acpica/acpica/releases/download/${PV}/${MY_P}.tar.gz
	test? ( https://github.com/acpica/acpica/releases/download/${PV}/${MY_TESTS_P}.tar.gz )"
S="${WORKDIR}/${MY_P}"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-20241212-Makefile-verbose.patch"
)
