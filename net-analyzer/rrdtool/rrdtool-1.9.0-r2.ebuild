...
inherit autotools distutils-r1 flag-o-matic lua perl-module

DESCRIPTION="A data logging and graphing system for time series data"
HOMEPAGE="https://oss.oetiker.ch/rrdtool/"
# upstream dist doesnt include python tests
SRC_URI="https://github.com/oetiker/rrdtool-1.x/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz"
...
src_configure() {
	...
	#
	# N.B. '-Ofast' enables '-ffast-math', so simply filtering
	#      '-ffast-math' is not sufficient.
	#
