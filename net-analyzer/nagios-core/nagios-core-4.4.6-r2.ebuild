...
IUSE="apache2 classicui lighttpd perl systemd vim-syntax +web"
...
src_configure() {
	...
	econf ${myconf} \
		...
		--with-lockfile="${EPREFIX%/}/var/lock/nagios.lock" \
...
src_install() {
	...
	use systemd && systemd_newunit startup/default-service nagios.service
