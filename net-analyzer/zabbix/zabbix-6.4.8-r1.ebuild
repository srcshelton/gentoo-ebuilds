...
WEBAPP_OPTIONAL="yes"
inherit autotools go-module java-pkg-opt-2 systemd tmpfiles toolchain-funcs user-info webapp
...
KEYWORDS="amd64 ~x86"
IUSE="agent +agent2 curl frontend gnutls ipv6 java ldap libxml2 mysql odbc openipmi +openssl oracle +postgres proxy selinux server snmp sqlite ssh static systemd"
