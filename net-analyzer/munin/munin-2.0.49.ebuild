...
inherit java-pkg-opt-2 systemd user webapp
...
IUSE="apache2 asterisk cgi dhcpd doc http ipmi ipv6 irc java ldap memcached minimal mysql postgres selinux ssl syslog systemd test"
