...
IUSE="bzip2 clamdtop clamonacc clamsubmit doc iconv ipv6 libclamav-only libressl metadata-analysis-api milter selinux systemd test uclibc xml"

REQUIRED_USE="libclamav-only? ( !clamdtop !clamonacc !clamsubmit !milter !metadata-analysis-api )"
