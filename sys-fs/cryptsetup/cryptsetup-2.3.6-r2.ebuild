...
inherit autotools linux-info tmpfiles usr-ldscript
...
IUSE="+argon2 gcrypt kernel nettle nls +openssl pwquality reencrypt split-usr static static-libs +tmpfiles +udev urandom"
