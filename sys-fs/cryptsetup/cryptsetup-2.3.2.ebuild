...
inherit autotools libtool linux-info usr-ldscript
...
IUSE="+argon2 gcrypt kernel libressl luks1_default nettle nls +openssl pwquality reencrypt split-usr static static-libs +udev urandom"
