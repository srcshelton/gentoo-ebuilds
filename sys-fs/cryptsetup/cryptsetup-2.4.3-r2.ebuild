...
inherit linux-info tmpfiles usr-ldscript
...
IUSE="+argon2 fips gcrypt kernel nettle nls +openssl pwquality reencrypt split-usr ssh static static-libs test +tmpfiles +udev urandom"
RESTRICT="!test? ( test )"
