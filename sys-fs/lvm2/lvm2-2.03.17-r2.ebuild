...
TMPFILES_OPTIONAL=1
inherit autotools flag-o-matic linux-info systemd tmpfiles toolchain-funcs udev
...
src_configure() {
	...
	local myeconfargs=(
		...
		$(usev !systemd --disable-udev-systemd-background-jobs)
...
pkg_postinst() {
	use lvm && use tmpfiles && tmpfiles_process lvm2.conf
