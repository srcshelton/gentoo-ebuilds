...
EAPI=7
inherit autotools flag-o-matic linux-info multilib systemd toolchain-funcs udev usr-ldscript
...
src_install() {
	...
	use systemd && INSTALL_TARGETS+=( install_tmpfiles_configuration install_systemd_units install_systemd_generators )
