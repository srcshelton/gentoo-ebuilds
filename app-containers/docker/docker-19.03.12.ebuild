...
LICENSE="Apache-2.0"
SLOT="0"
IUSE="apparmor aufs btrfs +container-init +contrib -device-mapper doc experimental fish-completion hardened +overlay seccomp systemd udev vim-syntax zsh-completion"
...
RDEPEND="
	...
	dev-libs/libltdl
	~app-containers/containerd-1.2.13
	~app-containers/runc-1.0.0_rc10[apparmor?,seccomp?]
	~app-containers/docker-proxy-0.8.0_p20191011
