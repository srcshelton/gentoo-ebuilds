...
LICENSE="Apache-2.0"
SLOT="0"
IUSE="apparmor aufs btrfs +contrib +device-mapper doc experimental hardened overlay seccomp systemd udev vim-syntax zsh-completion"
...
RDEPEND="
	...
	>=app-containers/containerd-0.2.5
	>=app-containers/runc-1.0.0_rc2-r2[apparmor?,seccomp?]
"
