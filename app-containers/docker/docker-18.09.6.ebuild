...
RDEPEND="
	...
	dev-libs/libltdl
	~app-containers/containerd-1.2.5
	~app-containers/runc-1.0.0_rc6_p20190216[apparmor?,seccomp?]
	~app-containers/docker-proxy-0.8.0_p20190417
...
src_compile() {
	...
	# ... however, this doesn't seem to quite cover it, so:
	emake \
		DISABLE_WARN_OUTSIDE_CONTAINER=1 \
		manpages || die
