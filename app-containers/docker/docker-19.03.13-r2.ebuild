...
RDEPEND="
	...
	dev-libs/libltdl
	~app-containers/containerd-1.3.7[apparmor?,btrfs?,device-mapper?,seccomp?,selinux?]
	~app-containers/runc-1.0.0_rc10[apparmor?,seccomp?,selinux(-)?]
	~app-containers/docker-proxy-0.8.0_p20200617
