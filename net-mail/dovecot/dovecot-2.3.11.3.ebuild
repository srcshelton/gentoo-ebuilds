...
IUSE="argon2 bzip2 caps doc ipv6 kerberos ldap libressl lua lucene lz4 lzma managesieve mysql pam postgres selinux sieve solr sqlite static-libs suid systemd tcpd textcat unwind vpopmail zlib"
