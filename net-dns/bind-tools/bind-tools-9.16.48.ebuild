...
src_prepare() {
	...
	# Fix hard-coding of .../lib/ - this appears to now be fixed and no
	# longer necessary, but does no harm in case anything has been missed.
	# A small fix-up of the resulting configure script is still helpful for
	# mysql support, though.
