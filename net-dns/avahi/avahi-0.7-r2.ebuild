...
inherit autotools eutils flag-o-matic ltprune multilib mono-env python-r1 systemd user multilib-minimal
...
multilib_src_install_all() {
	...
	# An empty 'run' directory is incorrectly created...
	[[ -d "${ED%/}"/run ]] && rmdir "${ED%/}"/run
}
