...
SLOT="0"
IUSE="bzip2 debuginfod libarchive +lzma nls stacktrace static-libs test +utils valgrind zstd"
RESTRICT="!test? ( test )"
...
PATCHES=(
	...
	"${FILESDIR}/${P}-debuginfod-profile.sh.patch"
)
...
multilib_src_configure() {
	...
	local myeconfargs=(
		...
		# upstream (marked experimental in configure) and doesn't build
		# either on musl.
