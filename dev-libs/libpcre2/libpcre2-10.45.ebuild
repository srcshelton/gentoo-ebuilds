...
inherit libtool multilib toolchain-funcs usr-ldscript verify-sig multilib-minimal
...
IUSE="bzip2 doc +jit libedit +pcre16 +pcre32 +readline static-libs unicode valgrind zlib"
