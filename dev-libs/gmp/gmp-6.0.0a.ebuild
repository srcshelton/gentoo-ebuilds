...
# $Id: 44d16473fb535de4f9143081517b77ae67f971ab $
...
pkg_preinst() {
	preserve_old_lib /usr/$(get_libdir)/libgmp$(get_libname 3)
}

pkg_postinst() {
	preserve_old_lib_notify /usr/$(get_libdir)/libgmp$(get_libname 3)
}
