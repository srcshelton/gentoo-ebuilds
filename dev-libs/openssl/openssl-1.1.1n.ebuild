...
inherit flag-o-matic toolchain-funcs usr-ldscript verify-sig multilib-minimal
...
IUSE="+asm cpu_flags_x86_sse2 rfc3779 sctp sslv3 static-libs test tls-compression tls-heartbeat vanilla verify-sig"
RESTRICT="!test? ( test )"
