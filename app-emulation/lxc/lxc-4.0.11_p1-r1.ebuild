...
SLOT="0"
IUSE="apparmor +caps checkpoint doc examples io-uring man pam seccomp selinux +ssl systemd +templates +tools verify-sig"
...
src_install() {
	...
	use systemd && systemd_newunit "${FILESDIR}"/lxc_at.service.4.0.0 "lxc@.service"
