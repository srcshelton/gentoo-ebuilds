...
# $Id: cacb5a376bca9e83dd7427cde8f5c88733cc1a01 $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/"${P}"-rp-pppoe-mtu.patch || die "epatch failed for rfc4638 MTU"
	epatch "${FILESDIR}"/"${P}"-discover-if.patch || die "epatch failed for interface discovery"
