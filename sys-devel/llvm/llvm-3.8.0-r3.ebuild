...
# $Id: 1f865eab1ad947ff4157b3f3b2e617e81777b82a $
...
#	fi
	...
	if tc-is-cross-compiler; then
		[[ -x "${EPREFIX:-}/usr/bin/llvm-tblgen" ]] \
			|| die "${EPREFIX:-}/usr/bin/llvm-tblgen not found or usable"
		mycmakeargs+=(
			-DCMAKE_CROSSCOMPILING=ON
			-DLLVM_TABLEGEN="${EPREFIX:-}/usr/bin/llvm-tblgen"
		)
