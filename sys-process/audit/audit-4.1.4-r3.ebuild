...
inherit autotools flag-o-matic linux-info python-r1 systemd tmpfiles toolchain-funcs usr-ldscript multilib-minimal
...
IUSE="gssapi io-uring ldap python static-libs systemd +tmpfiles zos"
...
"
IDEPEND="tmpfiles? ( virtual/tmpfiles )"
...
multilib_src_install() {
	...
	if multilib_is_native_abi; then
		...
		gen_usr_ldscript -a audit auparse auplugin
	fi
}
...
pkg_postinst() {
	...
	use !tmpfiles || tmpfiles_process audit.conf
}
