...
EAPI=8
EGIT_COMMIT='276cc20af6d27f34b324b4a8fae4ca93a5975ca2'

inherit flag-o-matic linux-info

DESCRIPTION="A Thread Stall Detector"
HOMEPAGE="https://gitlab.com/rt-linux-tools/stalld"
SRC_URI="https://gitlab.com/rt-linux-tools/${PN}/-/archive/${EGIT_COMMIT}/${PN}-${EGIT_COMMIT}.tar.bz2 -> ${PN}-v${PV}.tar.bz2"
RESTRICT="mirror"
