...
LICENSE+=" Apache-2.0 ISC MIT MPL-2.0 Unicode-3.0 Unicode-DFS-2016 WTFPL-2 ZLIB"
SLOT="0"
KEYWORDS="amd64 arm64 ppc64 ~riscv"
IUSE="bash-completion battery fish-completion gpu zfs zsh-completion"
...
src_install() {
	...
	if use bash-completion || use fish-completion || use zsh-completion; then
		...
		use bash-completion && newbashcomp btm.bash btm
		use fish-completion && dofishcomp btm.fish
		use zsh-completion && dozshcomp _btm
		popd > /dev/null || die
	fi
