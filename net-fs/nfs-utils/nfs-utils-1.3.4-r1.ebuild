...
IUSE="caps ipv6 kerberos +libmount nfsdcld +nfsidmap +nfsv4 nfsv41 selinux systemd tcpd +uuid"
...
src_install() {
	...
	# nfsdcltrack links to libraries (inc. libstdc++) which only exist beneath
	# the /usr mount-point
	dodir /usr/sbin
