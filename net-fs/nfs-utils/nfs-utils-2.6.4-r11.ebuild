...
LICENSE="GPL-2"
SLOT="0"
IUSE="caps junction kerberos ldap +libmount +nfsv3 +nfsv4 sasl selinux systemd tcpd udev +uuid"
...
src_install() {
	...
	if [[ -x "${ED}"/sbin/nfsdcltrack ]]; then
		# nfsdcltrack seems to be being built regardless of the 'nfsv4' USE
		# flag...
		#
