...
inherit linux-info pam python-single-r1 systemd tmpfiles waf-utils multilib-minimal
...
LICENSE="GPL-3"
SLOT="0"
IUSE="acl addc ads ceph client cluster cpu_flags_x86_aes cups debug fam glusterfs gpg iprint json ldap pam profiling-data python quota +regedit selinux snapper spotlight syslog systemd system-heimdal +system-mitkrb5 test +tmpfiles winbind zeroconf"
...
multilib_src_configure() {
	...
	local myconf=(
		...
		--with-piddir="${EPREFIX}/var/run/${PN}"
