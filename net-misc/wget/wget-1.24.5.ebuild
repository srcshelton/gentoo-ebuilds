...
SRC_URI="mirror://gnu/wget/${P}.tar.lz
	verify-sig? ( mirror://gnu/wget/${P}.tar.lz.sig )"
...
src_configure() {
	...
	# Causes compilation problems on ARM complaining of 'pow' being undefined
	use arm && filter-flags -funsafe-math-optimizations
