...
SLOT="0"
IUSE="adns bittorrent +gnutls jemalloc libuv +libxml2 metalink +nettle nls scripts sqlite ssh ssl tcmalloc test xmlrpc"
# xmlrpc has no explicit switch, it's turned on by any XML library
