...
LICENSE="GPL-3"
SLOT="0"
IUSE="acl cpu_flags_x86_sse2 examples iconv lz4 rrsync ssl stunnel systemd system-zlib xattr xxhash zstd"
...
if [[ ${PV} == *9999 ]] ; then
	...
	BDEPEND="${BDEPEND} verify-sig? ( sec-keys/openpgp-keys-waynedavison )"
fi
...
src_install() {
	...
	use systemd && systemd_newunit packaging/systemd/rsync.service rsyncd.service
}
