...
inherit autotools flag-o-matic multilib pam systemd toolchain-funcs user-info
...
IUSE="abi_mips_n32 audit bindist debug hpn kerberos ldns libedit libressl livecd pam +pie sctp selinux +ssl static test X X509 xmss" # -libseccomp
