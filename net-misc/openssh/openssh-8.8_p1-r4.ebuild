...
inherit autotools flag-o-matic pam systemd toolchain-funcs user-info verify-sig
...
IUSE="abi_mips_n32 audit debug hpn kerberos ldns libedit livecd pam +pie +scp sctp security-key selinux +ssl static systemd test X X509 xmss"
