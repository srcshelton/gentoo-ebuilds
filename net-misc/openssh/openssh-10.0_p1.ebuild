...
inherit autotools eapi9-ver flag-o-matic optfeature pam systemd toolchain-funcs user-info verify-sig
...
IUSE="abi_mips_n32 audit debug kerberos ldns libedit livecd pam +pie security-key selinux +ssl static systemd test user-service xmss"
