...
inherit autotools flag-o-matic multilib pam systemd toolchain-funcs user
...
IUSE="audit bindist debug hpn kerberos ldns libedit libressl -libseccomp livecd pam +pie sctp selinux skey +ssl static test X X509 abi_mips_n32 abi_x86_x32"
RESTRICT="!test? ( test )"
