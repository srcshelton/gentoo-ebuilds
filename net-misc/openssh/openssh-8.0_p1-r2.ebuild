...
IUSE="audit bindist debug hpn kerberos ldns libedit libressl livecd pam +pie sctp selinux +ssl static test X X509 abi_mips_n32 abi_x86_x32" # -libseccomp
RESTRICT="!test? ( test )"
...
src_configure() {
	...
	if use abi_x86_x32 # && ! use libseccomp
	then
