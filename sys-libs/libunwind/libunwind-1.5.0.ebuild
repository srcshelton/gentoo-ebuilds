...
MY_PV=${PV/_/-}
MY_P=${PN}-${MY_PV}
inherit autotools flag-o-matic libtool multilib-minimal multilib-minimal
...
src_prepare() {
	...
	# Let's wait for a proper fix upstream in https://github.com/libunwind/libunwind/issues/154
