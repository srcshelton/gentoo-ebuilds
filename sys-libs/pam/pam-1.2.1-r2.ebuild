...
inherit libtool multilib eutils pam toolchain-funcs flag-o-matic db-use fcaps usr-ldscript multilib-minimal
...
multilib_src_compile() {
	emake sepermitlockdir="${EPREFIX}/var/run/sepermit"
}
