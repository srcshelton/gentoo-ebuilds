...
inherit flag-o-matic gnuconfig multilib multiprocessing prefix python-any-r1 systemd tmpfiles toolchain-funcs
...
IUSE="audit caps cet compile-locales +crypt custom-cflags doc gd headers-only +multiarch multilib multilib-bootstrap nscd profile selinux +ssp +static-libs static-pie suid systemd systemtap test -timezone-tools +tmpfiles vanilla"
...
glibc_do_configure() {
	...
	if is_crosscompile; then
		# Assume worst-case bootstrap: glibc is built first time
