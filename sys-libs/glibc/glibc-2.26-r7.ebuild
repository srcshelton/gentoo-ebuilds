...
inherit prefix toolchain-funcs toolchain-glibc usr-ldscript
...
IUSE="audit caps debug doc gd hardened headers-only multilib nscd profile selinux suid systemd systemtap +tmpfiles vanilla"
