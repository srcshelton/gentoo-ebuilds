...
inherit eutils flag-o-matic gnuconfig multilib multiprocessing prefix \
...
IUSE="audit caps cet compile-locales doc gd headers-only +multiarch multilib nscd profile selinux +ssp suid systemd systemtap test +tmpfiles vanilla"
