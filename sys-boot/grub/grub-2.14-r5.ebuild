...
inherit bash-completion-r1 eapi9-pipestatus eapi9-ver flag-o-matic multibuild optfeature python-any-r1 secureboot toolchain-funcs verify-sig
...
SLOT="2/${PVR}"
IUSE="-branding +device-mapper doc efiemu -fonts grub_platforms_coreboot grub_platforms_efi-32 grub_platforms_efi-64 grub_platforms_emu grub_platforms_ieee1275 grub_platforms_loongson grub_platforms_multiboot grub_platforms_pc grub_platforms_qemu grub_platforms_qemu-mips grub_platforms_uboot grub_platforms_xen grub_platforms_xen-32 grub_platforms_xen-pvh libzfs mount nls protect sdl test +themes truetype"
