...
SLOT="0"
IUSE="+64bit -devicetree -kernel rpi0 rpi02 rpi1 rpi2 rpi3 rpi4 rpi400 rpi5 rpi500 +rpi-all rpi-cm rpi-cm2 rpi-cm3 rpi-cm4 rpi-cm4-io rpi-cm4s rpi-cm5 rpi-cm5-io"
REQUIRED_USE="
...
if [[ "${PV}" == *9999 ]]; then
	...
	KEYWORDS="-* arm64"  # Broken on 'arm' - see https://github.com/raspberrypi/firmware/issues/1953
