...
src_prepare() {
	...
	post_vendor_patches=(
		...
		"${FILESDIR}"/7.0.x/50060-watchdog-sbsa-gwdt-use-cix-sky1-refresh-value.patch
		...
		"${FILESDIR}"/7.0.x/80020-rtw89-check-acpi-dsm-before-evaluating.patch
	...
	eapply \
		...
		"${FILESDIR}"/7.0.x/90098-pstore-ramoops-parse-firmware-node-properties.patch || die
