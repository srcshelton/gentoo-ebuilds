...
| --- | --- | --- | --- |
| [Linux 6.18.46](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tag/?h=v6.18.46) | `cix-sources-6.18.46` | `6.18-53` base, extras, and experimental | [`cix-linux-main` at `bc078a3`](https://github.com/cixtech/cix-linux-main/commit/bc078a383042a6c14b05c56e12390e422f893088) |
| [Linux 7.1.9](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tag/?h=v7.1.9) | `cix-sources-7.1.9` | `7.1-12` base and extras | same CIX source |
| [Linux 7.2.0](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tag/?h=v7.2) | `cix-sources-7.2.0` | `7.2-1` base and extras | same CIX source |
...
| Kernel | `6.18.46`, `7.1.9`, `7.2.0` | The maintained Linux version. |
...
maintained configurations. “All” means Linux 6.18.46, 7.1.9, and 7.2.0.
...
| --- | --- | --- | --- |
| 6.18.46 | `1000_linux-6.18.1.patch` through `1045_linux-6.18.46.patch` | `1510_fs-enable-link-security-restrictions-by-default.patch`<br>`1700_sparc-address-warray-bound-warnings.patch`<br>`1730_parisc-Disable-prctl.patch`<br>`2000_BT-Check-key-sizes-only-if-Secure-Simple-Pairing-enabled.patch`<br>`2901_permit-menuconfig-sorting.patch`<br>`2920_sign-file-patch-for-libressl.patch`<br>`2990_libbpf-v2-workaround-Wmaybe-uninitialized-false-pos.patch`<br>`2991_libbpf_add_WERROR_option.patch`<br>`3000_Support-printing-firmware-info.patch`<br>`4567_distro-Gentoo-Kconfig.patch` | Updates Linux 6.18.0 to 6.18.46 and applies the pinned Gentoo defaults and compatibility fixes. The updated Gentoo Kconfig patch makes the former local ARM64 dependency workaround unnecessary. |
| 7.1.9 | `1001_linux-7.1.1.patch`, `1001_linux-7.1.2.patch`, and `1002_linux-7.1.3.patch` through `1008_linux-7.1.9.patch` | `1510_fs-enable-link-security-restrictions-by-default.patch`<br>`1700_sparc-address-warray-bound-warnings.patch`<br>`1710_x86-tools-vdso2c.patch`<br>`1730_parisc-Disable-prctl.patch`<br>`2000_BT-Check-key-sizes-only-if-Secure-Simple-Pairing-enabled.patch`<br>`2901_permit-menuconfig-sorting.patch`<br>`2902_Replace-CONST-CAST-with-const-cast.patch`<br>`2990_libbpf-v2-workaround-Wmaybe-uninitialized-false-pos.patch`<br>`2991_libbpf_add_WERROR_option.patch`<br>`3000_Support-printing-firmware-info.patch`<br>`4567_distro-Gentoo-Kconfig.patch` | Updates Linux 7.1.0 to 7.1.9 and applies the pinned Gentoo security, build, and configuration fixes. Stable thermal-hwmon grouping, Bluetooth, CPPC, schedutil, and Panthor corrections remain intact alongside the CIX adaptations. |
| 7.2.0 | Base release; no stable point-update files | `1510_fs-enable-link-security-restrictions-by-default.patch`<br>`1700_sparc-address-warray-bound-warnings.patch`<br>`1710_x86-tools-vdso2c.patch`<br>`1730_parisc-Disable-prctl.patch`<br>`2000_BT-Check-key-sizes-only-if-Secure-Simple-Pairing-enabled.patch`<br>`2901_permit-menuconfig-sorting.patch`<br>`2902_Replace-CONST-CAST-with-const-cast.patch`<br>`2990_libbpf-v2-workaround-Wmaybe-uninitialized-false-pos.patch`<br>`2991_libbpf_add_WERROR_option.patch`<br>`3000_Support-printing-firmware-info.patch`<br>`4567_distro-Gentoo-Kconfig.patch` | Applies the pinned Gentoo security, build, and configuration fixes to Linux 7.2.0. |
...
| Clocks and resets | `0004-clk-scmi-add-audited-acpi-publication.patch`<br>`0005-clk-cix-add-audited-sky1-support.patch`<br>`0006-reset-cix-add-audited-sky1-support.patch`<br>`0018-clk-clkdev-increase-clkdev-MAX_CON_ID-from-16-to-32.patch`<br>`0018-clk-clkdev-accept-long-identifiers.patch` | Core files: all; the two `0018` forms apply to 6.18/7.1 and 7.2 respectively | Publishes SCMI clocks to ACPI consumers and supplies the Sky1 clock and reset controllers, including longer firmware clock names. Retryable clock-provider deferral is handled without a false invalid-CLKT error, overlapping reset/syscon resources are matched by exact CIX provider identity rather than address alone, and intentionally overlapping child register windows are mapped without claiming exclusive ownership. |
...
| I2C and SPI | `0019-i2c-cadence-add-audited-acpi-support.patch`<br>`50130-spi-cadence-add-audited-cix-acpi-support.patch` | All | Enables the Cadence I2C and classic SPI controllers from ACPI with validated firmware limits and correct clock/reset deferral. Linux 6.18.46 also exposes its new Sky1 16- and 32-bit classic-SPI transfers to the ACPI-described controller rather than only to the DT compatible. |
