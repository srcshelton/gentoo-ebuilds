...
KV_MINOR="20"
MY_PV="20250326"
EGIT_COMMIT="cd231d4775b14f228606c09f219b48308f6ab3aa"
ETYPE="headers"
...
PATCH_VER="1"
PATCH_DEV="sam"
SRC_URI="https://github.com/raspberrypi/linux/archive/${EGIT_COMMIT:-"${MY_PV}"}.tar.gz -> raspberrypi-sources-${PV}.${KV_MINOR}_p${MY_PV#*_}.tar.gz
