...
multilib_src_configure() {
	...
	if use arm64 && { use clang || tc-is-clang; }; then
		# error: LLVM gold plugin: <unknown>:0: value evaluated as 4611686018427387685 is out of range.
		...
		# Prevent, e.g.:
		#
		#  In file included from llvm-runtimes/libcxxabi-21.1.8/work/runtimes_build-.arm64/include/c++/v1/__compare/strong_order.h:17:
		#  llvm-runtimes/libcxxabi-21.1.8/work/runtimes_build-.arm64/include/c++/v1/__math/traits.h:94:10: warning: use of infinity is undefined behavior due to the currently enabled floating-point options [-Wnan-infinity-disabled]
