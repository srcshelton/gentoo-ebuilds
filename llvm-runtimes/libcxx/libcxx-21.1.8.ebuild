...
IUSE="+clang +libcxxabi polly +static-libs test"
...
multilib_src_configure() {
	...
	if use arm64 && { use clang || tc-is-clang; }; then
		# error: LLVM gold plugin: <unknown>:0: value evaluated as 4611686018427387883 is out of range.
		...
		# Prevent, e.g.:
		#
		#  In file included from llvm-runtimes/libcxx-21.1.8/work/runtimes_build-.arm64/include/c++/v1/cmath:330:
		#  llvm-runtimes/libcxx-21.1.8/work/runtimes_build-.arm64/include/c++/v1/__math/special_functions.h:55:19: warning: use of infinity is undefined behavior due to the currently enabled floating-point options [-Wnan-infinity-disabled]
		#     55 |     _Real __inf = std::numeric_limits<_Real>::infinity();
		#        |                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		#  llvm-runtimes/libcxx-21.1.8/work/runtimes_build-.arm64/include/c++/v1/__math/special_functions.h:62:85: note: in instantiation of function template specialization 'std::__hermite<double>' requested here
		#     62 | inline _LIBCPP_HIDE_FROM_ABI double hermite(unsigned __n, double __x) { return std::__hermite(__n, __x); }
		#        |                                                                                     ^
		#  llvm-runtimes/libcxx-21.1.8/work/runtimes_build-.arm64/include/c++/v1/__math/special_functions.h:55:19: warning: use of infinity is undefined behavior due to the currently enabled floating-point options [-Wnan-infinity-disabled]
		#     55 |     _Real __inf = std::numeric_limits<_Real>::infinity();
		#        |                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		#  llvm-runtimes/libcxx-21.1.8/work/runtimes_build-.arm64/include/c++/v1/__math/special_functions.h:69:95: note: in instantiation of function template specialization 'std::__hermite<long double>' requested here
	...
	if use clang; then
		...
		if ! use polly; then
			filter-flags '-f*plugin=LLVMPolly.so'
			filter-flags '-mllvm=-polly*'
			filter-flags '-mllvm -polly*'
		fi
