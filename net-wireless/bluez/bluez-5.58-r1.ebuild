...
IUSE="btpclient cups debug deprecated doc experimental extra-tools +mesh midi +obex +readline selinux systemd test test-programs +udev user-session"
...
multilib_src_install_all() {
	...
	# But we keep installing them for 'historical' reasons
