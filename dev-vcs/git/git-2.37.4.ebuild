...
inherit bash-completion-r1 perl-module plocale python-single-r1 systemd toolchain-funcs
...
LICENSE="GPL-2"
SLOT="0"
IUSE="+blksha1 cgi +curl cvs doc gnome-keyring +gpg highlight +iconv mediawiki mediawiki-experimental +nls +pcre perforce +perl +ppcsha1 +safe-directory selinux subversion systemd test tk +webdav xinetd"
