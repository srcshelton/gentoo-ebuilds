...
inherit autotools db-use eapi7-ver flag-o-matic multilib ssl-cert systemd toolchain-funcs user multilib-minimal
...
IUSE_DAEMON="crypt experimental minimal samba slp systemd tcpd"
IUSE_BACKEND="+berkdb"
