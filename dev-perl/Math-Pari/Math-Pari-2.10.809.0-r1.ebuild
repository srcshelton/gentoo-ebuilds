...
src_configure() {
	...
	# This is a horrible, horrible hack - but on systems where the word-length
	...
	# that the configure stage detects the correct architecture.  Instead, we
	# cunningly define and export a shell-function named 'perl' which is called
	# in place of the perl binary and which itself invokes the perl binary,
	# but in the correct context.  We then remove this ASAP since, let's face
	# it, this is bound to be hugely fragile...
