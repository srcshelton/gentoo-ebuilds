...
inherit libtool pam usr-ldscript
...
IUSE="acl audit bcrypt cracklib nls pam selinux skey -su xattr"
...
src_install() {
	...
	if use split-usr ; then
		...
		#
		# We cannot simply remove this or else net-misc/scponly and other tools
		# will break because of hardcoded 'passwd' locations
		dodir /bin
