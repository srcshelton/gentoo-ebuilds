...
inherit bash-completion-r1 flag-o-matic linux-info meson-multilib python-single-r1 secureboot shell-completion toolchain-funcs udev
...
IUSE="+acl boot kernel-install +kmod selinux split-usr +sysctl sysusers test +tmpfiles +udev ukify"
REQUIRED_USE="
