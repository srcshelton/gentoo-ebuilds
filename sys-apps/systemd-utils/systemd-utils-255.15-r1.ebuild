...
inherit bash-completion-r1 flag-o-matic linux-info meson-multilib ninja-utils python-single-r1 secureboot toolchain-funcs udev
...
IUSE="+acl boot kernel-install +kmod selinux split-usr sysusers test +tmpfiles +udev ukify"
REQUIRED_USE="
