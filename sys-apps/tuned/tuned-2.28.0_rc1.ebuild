...
inherit optfeature python-single-r1 tmpfiles toolchain-funcs xdg-utils

MY_PV="${PV/_rc/-rc.}"
DESCRIPTION="Daemon for monitoring and adaptive tuning of system devices"
HOMEPAGE="https://github.com/redhat-performance/tuned"
SRC_URI="https://github.com/redhat-performance/tuned/archive/v${MY_PV}.tar.gz -> ${P}.tar.gz"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64"
IUSE="bash-completion +dbus gtk ppd selinux +server systemd-boot +systemtap +tmpfiles"
