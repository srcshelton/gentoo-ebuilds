...
inherit dot-a libtool usr-ldscript multilib-minimal
...
# attr dep should be obsolete with >=2.4.0 but there's a configure check left,
# and also some header use in libacl/ still (bug #978746, reported on
# acl-devel at [1]).
# [1] https://lists.nongnu.org/archive/html/acl-devel/2026-07/msg00000.html
RDEPEND="
	>=sys-apps/attr-2.4.47-r1[${MULTILIB_USEDEP}]
"
DEPEND="${RDEPEND}"
BDEPEND="${BDEPEND} nls? ( sys-devel/gettext )"
