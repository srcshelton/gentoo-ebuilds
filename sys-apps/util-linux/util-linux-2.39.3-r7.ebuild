...
inherit autotools bash-completion-r1 flag-o-matic libtool multiprocessing pam python-r1 usr-ldscript systemd toolchain-funcs usr-ldscript multilib-minimal
