...
inherit alternatives eutils flag-o-matic multilib multiprocessing prefix toolchain-funcs
...
IUSE="berkdb debug doc gdbm ithreads +perl-cleaner"
...
DEPEND="${RDEPEND}"
PDEPEND="
	perl-cleaner? ( >=app-admin/perl-cleaner-2.5 )
...
#
# perl-cleaner pulls in a large list of dependencies (including python and
# portage), so give the option to remove this dependency for use with immutable
# builds, etc.
...
src_prepare() {
	...
	eprefixify "${S}"/cpan/HTTP-Tiny/lib/HTTP/Tiny.pm
