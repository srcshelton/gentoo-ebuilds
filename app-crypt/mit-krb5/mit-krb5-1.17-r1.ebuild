...
inherit autotools flag-o-matic python-any-r1 systemd usr-ldscript multilib-minimal
...
IUSE="doc +keyutils libressl lmdb nls openldap +pkinit selinux systemd +threads test usr-ldscript xinetd cpu_flags_x86_aes"
